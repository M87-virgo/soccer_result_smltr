...
void SqLiteDBEditor::showNationRivalsTable()
{
    ...
    sqlCommand.exec("SELECT idnationalteam_rivals AS id_nr, nc.name_country AS Team, nac.name_country AS Rival FROM nationalteam_rivals AS nriv "
...
void SqLiteDBEditor::showClubRivalsTable()
{
    ...
    sqlCommand.exec("SELECT idclub_rivals AS id_cr, cl.name_club AS Team, clu.name_club AS Rival FROM club_rivals AS criv "
...
SqLiteDBEditor::SqLiteDBEditor(QWidget *parent) : QDialog(parent), ui(new Ui::SqLiteDBEditor)
{
    ...
    ui -> CmdSaveRivals -> setStyleSheet(" :disabled { color: white; "
                                         "border-image: url(:/miscRsc/misc_icons/filesave_128x128_disabled) 3 10 3 10; border-top: 3px transparent; "
                                         "border-bottom: 3px transparent; "
                                         "border-right: 10px transparent; "
                                         "border-left: 10px transparent } "
                                         ":enabled { color: white; "
                                         "border-image: url(:/miscRsc/misc_icons/filesave_128x128) 3 10 3 10; border-top: 3px transparent; "
                                         "border-bottom: 3px transparent; "
                                         "border-right: 10px transparent; "
                                         "border-left: 10px transparent } "
                                         " :pressed { color: white; "
